...
%         fprintf(fid,'  G12TouchedAp');
    ...
    for Sub = Subjects
        ...
        if(contains(Task,'Grasp')||strcmp(Task,'ManEst'))
            sumFGApBl1 = 0; % summation of final grip aperture for block 1
            sumFGApBl2 = 0;
            sumFGApBl3 = 0;
            sumFGApBl4 = 0;
            c1 = 0;
            ...
            for Trial = 1:CurrNoTrials
                ...
                disp(eval.LeftDiscAreaAp) 
                    if (contains(eval.BlTp,'1') && ~isnan(eval.LeftDiscAreaAp))
                        sumFGApBl1 = sumFGApBl1 + eval.LeftDiscAreaAp;
                        c1 = c1 + 1;
                    elseif (contains(eval.BlTp,'2') && ~isnan(eval.LeftDiscAreaAp))
                        sumFGApBl2 = sumFGApBl2 + eval.LeftDiscAreaAp;
                        c2 = c2 + 1;
                    elseif (contains(eval.BlTp,'3') && ~isnan(eval.LeftDiscAreaAp))
                        sumFGApBl3 = sumFGApBl3 + eval.LeftDiscAreaAp;
                        c3 = c3 + 1;
                    elseif (contains(eval.BlTp,'4') && ~isnan(eval.LeftDiscAreaAp))
            ...
            avgFGApBl4 = sumFGApBl4 / c4;
            
            G12FWBl1 = avgFGApBl1 - 40; % subtract smaller disk size to get finger width
            G12FWBl2 = avgFGApBl2 - 40;
            G12FWBl3 = avgFGApBl3 - 40;
            G12FWBl4 = avgFGApBl4 - 40;
        end
