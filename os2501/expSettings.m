...
epar.ExpColl.CollectionTime         =  2.5; %Number of seconds of data to collect.        
...
epar.PresentationTime        = 2; %sec, presentation of stimuli 
...
epar.ManEstSubjects = [1:56]; 
epar.GraspSubjects  = [1:56];
epar.PercSubjects   = [1:56];
epar.ExPercSubjects = [1:56];
